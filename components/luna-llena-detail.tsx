...
export default function LunaLlenaDetail({ onNavigate }: LunaLlenaDetailProps) {
  ...
  const galleryMedia = [
    ...
    { type: "image", src: "https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=400&q=80", alt: "Luna Llena event 2" },
    { type: "image", src: "https://images.unsplash.com/photo-1571266028243-3716f02d3a52?w=400&q=80", alt: "Luna Llena event 3" },
    { type: "video", src: "https://images.unsplash.com/photo-1504680177321-2e6a879aac86?w=400&q=80", alt: "Luna Llena video 1" },
    { type: "image", src: "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=400&q=80", alt: "Luna Llena event 4" },
    { type: "image", src: "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=400&q=80", alt: "Luna Llena event 5" },
  ]
