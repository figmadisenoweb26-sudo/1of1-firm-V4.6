...
export default function EventDetail({ onNavigate }: EventDetailProps) {
  ...
  const galleryMedia = [
    ...
    { type: "image", src: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=400&q=80", alt: "Babadook event 2" },
    { type: "image", src: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&q=80", alt: "Babadook event 3" },
    { type: "image", src: "https://images.unsplash.com/photo-1429962714451-bb934ecdc4ec?w=400&q=80", alt: "Babadook event 4" },
    { type: "video", src: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400&q=80", alt: "Babadook video 1" },
    { type: "image", src: "https://images.unsplash.com/photo-1504680177321-2e6a879aac86?w=400&q=80", alt: "Babadook event 5" },
  ]
