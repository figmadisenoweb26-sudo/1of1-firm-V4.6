...
export default function LaFestaDetail({ onNavigate }: LaFestaDetailProps) {
  ...
  const galleryMedia = [
    ...
    { type: "image", src: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&q=80", alt: "La Festa event 2" },
    { type: "video", src: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&q=80", alt: "La Festa video 1" },
    { type: "image", src: "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=400&q=80", alt: "La Festa event 3" },
    { type: "image", src: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400&q=80", alt: "La Festa event 4" },
    { type: "image", src: "https://images.unsplash.com/photo-1429962714451-bb934ecdc4ec?w=400&q=80", alt: "La Festa event 5" },
  ]
