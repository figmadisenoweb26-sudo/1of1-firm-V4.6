...
export default function CelestialDetail({ onNavigate }: CelestialDetailProps) {
  ...
  const galleryMedia = [
    ...
    { type: "image", src: "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=400&q=80", alt: "Celestial event 2" },
    { type: "video", src: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&q=80", alt: "Celestial video 1" },
    { type: "image", src: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=400&q=80", alt: "Celestial event 3" },
    { type: "image", src: "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=400&q=80", alt: "Celestial event 4" },
    { type: "image", src: "https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=400&q=80", alt: "Celestial event 5" },
  ]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[60vh] sm:min-h-[75vh] md:min-h-screen flex flex-col justify-end pb-6 sm:pb-10 md:pb-12">
        ...
        <div className="relative z-10 px-4 sm:px-6 md:px-8 text-center mt-24 sm:mt-32 md:mt-40">
          ...
          <div className="space-y-1 mb-4 sm:mb-6 md:mb-8">
            <p className="text-white/60 text-[10px] sm:text-xs md:text-sm tracking-[0.15em] sm:tracking-[0.2em] md:tracking-[0.3em]">BARRANQUILLA</p>
            <p className="text-amber-500/80 text-[9px] sm:text-[10px] md:text-xs tracking-[0.15em] sm:tracking-[0.2em] md:tracking-[0.3em]">COMING SOON</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-6 sm:py-8 max-w-lg mx-auto">
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-4 mb-4 sm:mb-6">
          ...
          <span className="text-amber-500 text-[9px] sm:text-xs tracking-[0.1em] sm:tracking-[0.2em] whitespace-nowrap">EARLY BIRD · ETAPA CREYENTES</span>
          <div className="h-px bg-amber-500/30 flex-1" />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          ...
          <div className="border border-amber-500/30 p-4 sm:p-6 text-center bg-black/50">
            ...
            <div className="mb-2">
              <span className="text-2xl sm:text-3xl font-light text-amber-500">45K</span>
            </div>
          </div>
          ...
          <div className="border border-amber-500/30 p-4 sm:p-6 text-center bg-black/50">
            ...
            <div className="mb-2">
              <span className="text-2xl sm:text-3xl font-light text-amber-500">500K</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-white/80 text-xs sm:text-sm tracking-wide sm:tracking-wider">BARRANQUILLA</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-white/80 text-xs sm:text-sm tracking-wide sm:tracking-wider">FECHA PRÓXIMAMENTE</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-500/60 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      {/* CTA Button */}
      <section className="px-4 py-6 sm:py-8 max-w-lg mx-auto">
        <button className="w-full py-3 sm:py-4 bg-amber-500 text-black text-sm sm:text-base font-medium tracking-widest hover:bg-amber-400 transition-colors">
          RESERVAR MI LUGAR
        </button>
