...
export default function AnimalDetail({ onNavigate }: AnimalDetailProps) {
  ...
  const galleryMedia = [
    ...
    { type: "image", src: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&q=80", alt: "Animal event 2" },
    { type: "video", src: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=400&q=80", alt: "Animal video 1" },
    { type: "image", src: "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=400&q=80", alt: "Animal event 3" },
    { type: "image", src: "https://images.unsplash.com/photo-1574680096145-d05b474e2155?w=400&q=80", alt: "Animal event 4" },
    { type: "image", src: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=400&q=80", alt: "Animal event 5" },
  ]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] flex flex-col justify-center pb-6 sm:pb-8">
        ...
        <div className="relative z-10 px-4 sm:px-6 md:px-8 flex flex-col items-center justify-center text-center h-full pt-20 sm:pt-24">
          ...
          <p className="text-amber-500/80 text-xs sm:text-sm tracking-widest mb-4 sm:mb-8">MÁS SALVAJE. +14 SIN ALCOHOL</p>

          {/* Date and Location */}
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center justify-center gap-2 sm:gap-3">
              <Calendar className="w-3 h-3 sm:w-4 sm:h-4 text-white/60" />
              <span className="text-white/80 text-xs sm:text-sm tracking-wider">SÁBADO 17 DE MAYO</span>
            </div>
            <div className="flex items-center justify-center gap-2 sm:gap-3">
              <MapPin className="w-3 h-3 sm:w-4 sm:h-4 text-white/60" />
              <div className="text-center">
                <span className="text-white/80 text-xs sm:text-sm tracking-wider block">DISCOLO NIGHT CLUB</span>
                <span className="text-white/60 text-[10px] sm:text-sm tracking-wider">BARRANQUILLA</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="border border-white/20 p-2 sm:p-4 text-center bg-white/5">
            ...
            <div className="mb-3 sm:mb-4">
              <span className="text-xl sm:text-2xl font-light text-white">$45.000</span>
              <span className="text-white/60 text-[10px] sm:text-xs ml-1">COP</span>
            </div>
            <button className="w-full py-2 border border-white/30 text-white text-[10px] sm:text-xs tracking-widest hover:bg-white/10 transition-colors">
              COMPRAR
            </button>
          </div>
      ...
      <section className="px-3 sm:px-4 py-4 sm:py-6">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <button className="px-6 sm:px-8 py-2.5 sm:py-3 bg-amber-500 text-black text-xs sm:text-sm font-medium tracking-widest hover:bg-amber-400 transition-colors flex items-center gap-2 mx-auto">
              COMPRAR ENTRADAS
